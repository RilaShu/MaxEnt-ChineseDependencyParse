...
public class CreateModel {
    ...
    public static double SMOOTHING_OBSERVATION = 0.2;

    private static void usage() {
        System.err.println("java CreateModel [-real] [-perceptron] dataFile iteration cutoff threads");
        System.exit(1);
    }
        ...
        try {
            ...
            if (type.equals("maxent")) {
                ...
                if (!real) {
                    ...
                    model = GIS.trainModel(iterations, new OnePassRealValueDataIndexer(es,cutoff), true, USE_SMOOTHING, (Prior)null, cutoff, threads);
                }
